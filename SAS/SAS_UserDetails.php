    ...
    <?php
        ...
        if (isset($_POST['uid'])) {
            ...
            switch ($user_identity) {
                case 'T':
                    $sql_query = "select * from teacher_profile where t_uid='" . $user_id . "'";
                    break;
                case 'S':
                    $sql_query = "select * from basicinfo where uid='" . $user_id . "'";
                    break;
                case 'L':
                    $sql_query = "select * from landlord where uid='" . $user_id . "'";
                    break;
            }
            ...
            if ($result->rowCount() > 0) {
                ...
                switch ($user_identity) {
                    ...
                    case 'S':
                        ...
                        echo '</tr>';
                        echo '<tr>';
                            echo '<td><label for="student_Tname">學生主修系所</label></td><td><input type="text" name="student_major"></td>';
